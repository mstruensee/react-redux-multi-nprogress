...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducer = (0, _redux.combineReducers)({
	  pendingTasks: _src.pendingTasksReducer
	});
	...
	var App = function (_React$Component) {
	  ...
	  function App(props, context) {
	    ...
	    _this.state = {
	      pendingTasks: _this.store.getState().pendingTasks
	    };
	  ...
	  _createClass(App, [{
	    ...
	    value: function increase() {
	      store.dispatch(_defineProperty({
	        type: 'FETCHING_ASYNC_DATA'
	      }, _src.pendingTask, _src.begin));
	    }
	  }, {
	    key: 'decrease',
	    // key surrounded by [] to evaluate the value
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nprogress = __webpack_require__(177);
